...
class Atri:
	def __init__(self, state: Any):
		...
		self.errorbox = state["errorbox"]
		self.errorwrapper = state["errorwrapper"]
		self._setter_access_tracker = {}
	...
	def Flex345(self, new_state):
		...
		global default_state
		self._Flex345 = Flex345Class(new_state, default_state["Flex345"])
	...
	def Image142(self, new_state):
		...
		global default_state
		self._Image142 = Image142Class(new_state, default_state["Image142"])
	...
	def Flex346(self, new_state):
		...
		global default_state
		self._Flex346 = Flex346Class(new_state, default_state["Flex346"])
	...
	def Image145(self, new_state):
		...
		global default_state
		self._Image145 = Image145Class(new_state, default_state["Image145"])
	...
	def Flex348(self, new_state):
		...
		global default_state
		self._Flex348 = Flex348Class(new_state, default_state["Flex348"])
	...
	def TextBox179(self, new_state):
		...
		global default_state
		self._TextBox179 = TextBox179Class(new_state, default_state["TextBox179"])
	...
	def Flex349(self, new_state):
		...
		global default_state
		self._Flex349 = Flex349Class(new_state, default_state["Flex349"])
	...
	def TextBox181(self, new_state):
		...
		global default_state
		self._TextBox181 = TextBox181Class(new_state, default_state["TextBox181"])

	@property
	def username(self):
		self._getter_access_tracker["username"] = {}
		return self._username
	@username.setter
	def username(self, new_state):
		self._setter_access_tracker["username"] = {}
		global default_state
		self._username = usernameClass(new_state, default_state["username"])
	...
	@property
	def password(self):
		self._getter_access_tracker["password"] = {}
		return self._password
	@password.setter
	def password(self, new_state):
		self._setter_access_tracker["password"] = {}
		global default_state
		self._password = passwordClass(new_state, default_state["password"])
	...
	def Flex352(self, new_state):
		...
		global default_state
		self._Flex352 = Flex352Class(new_state, default_state["Flex352"])
	...
	def Flex353(self, new_state):
		...
		global default_state
		self._Flex353 = Flex353Class(new_state, default_state["Flex353"])

	@property
	def errorbox(self):
		self._getter_access_tracker["errorbox"] = {}
		return self._errorbox
	@errorbox.setter
	def errorbox(self, new_state):
		self._setter_access_tracker["errorbox"] = {}
		global default_state
		self._errorbox = errorboxClass(new_state, default_state["errorbox"])

	@property
	def errorwrapper(self):
		self._getter_access_tracker["errorwrapper"] = {}
		return self._errorwrapper
	@errorwrapper.setter
	def errorwrapper(self, new_state):
		self._setter_access_tracker["errorwrapper"] = {}
		global default_state
		self._errorwrapper = errorwrapperClass(new_state, default_state["errorwrapper"])
	...
	def _to_json_fields(self):
		return {
			...
			"errorbox": self._errorbox,
			"errorwrapper": self._errorwrapper,
			}


class Flex345ClassstylesClass:
...
class Flex345Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex345ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		...
		self._styles = Flex345ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Image142ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image142ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image142Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image142ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image142ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image142ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
	...
	def custom(self, state):
		...
		self._custom = Image142ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex346Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex346ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex346ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Image145ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image145ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image145Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image145ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image145ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image145ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image145ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex348Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex348ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex348ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class TextBox179ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox179ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox179Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox179ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox179ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox179ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox179ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex349Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex349ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex349ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class TextBox181ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox181ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox181Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox181ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox181ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox181ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox181ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class usernameClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class usernameClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class usernameClass:
	def __init__(self, state, def_state):
		...
		self.styles: usernameClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: usernameClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = usernameClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = usernameClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class passwordClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class passwordClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class passwordClass:
	def __init__(self, state, def_state):
		...
		self.onChange = False
		self.onPressEnter = False
		self.styles: passwordClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: passwordClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = passwordClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = passwordClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex352Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex352ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex352ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex353Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex353ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex353ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class errorboxClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class errorboxClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class errorboxClass:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: errorboxClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: errorboxClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = errorboxClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = errorboxClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class errorwrapperClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class errorwrapperClass:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: errorwrapperClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = errorwrapperClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
