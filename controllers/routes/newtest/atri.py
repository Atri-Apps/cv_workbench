...
class Atri:
	def __init__(self, state: Any):
		...
		self.image_placeholder = state["image_placeholder"]
		self.runtest = state["runtest"]
		self.TextBox113 = state["TextBox113"]
		self.Image115 = state["Image115"]
		self.preview = state["preview"]
		self.preview_wrapper = state["preview_wrapper"]
	...
	def TextBox107(self, new_state):
		...
		global default_state
		self._TextBox107 = TextBox107Class(new_state, default_state["TextBox107"])
	...
	def TextBox108(self, new_state):
		...
		global default_state
		self._TextBox108 = TextBox108Class(new_state, default_state["TextBox108"])
	...
	def Image112(self, new_state):
		...
		global default_state
		self._Image112 = Image112Class(new_state, default_state["Image112"])
	...
	def Image113(self, new_state):
		...
		global default_state
		self._Image113 = Image113Class(new_state, default_state["Image113"])
	...
	def TextBox109(self, new_state):
		...
		global default_state
		self._TextBox109 = TextBox109Class(new_state, default_state["TextBox109"])
	...
	def Button18(self, new_state):
		...
		global default_state
		self._Button18 = Button18Class(new_state, default_state["Button18"])
	...
	def Flex231(self, new_state):
		...
		global default_state
		self._Flex231 = Flex231Class(new_state, default_state["Flex231"])
	...
	def Flex235(self, new_state):
		...
		global default_state
		self._Flex235 = Flex235Class(new_state, default_state["Flex235"])
	...
	def Flex236(self, new_state):
		...
		global default_state
		self._Flex236 = Flex236Class(new_state, default_state["Flex236"])
	...
	def TextBox111(self, new_state):
		...
		global default_state
		self._TextBox111 = TextBox111Class(new_state, default_state["TextBox111"])
	...
	def TextBox112(self, new_state):
		...
		global default_state
		self._TextBox112 = TextBox112Class(new_state, default_state["TextBox112"])
	...
	def Flex237(self, new_state):
		...
		global default_state
		self._Flex237 = Flex237Class(new_state, default_state["Flex237"])
	...
	def Image114(self, new_state):
		...
		global default_state
		self._Image114 = Image114Class(new_state, default_state["Image114"])

	@property
	def image_placeholder(self):
		self._getter_access_tracker["image_placeholder"] = {}
		return self._image_placeholder
	@image_placeholder.setter
	def image_placeholder(self, new_state):
		self._setter_access_tracker["image_placeholder"] = {}
		global default_state
		self._image_placeholder = image_placeholderClass(new_state, default_state["image_placeholder"])

	@property
	def runtest(self):
		self._getter_access_tracker["runtest"] = {}
		return self._runtest
	@runtest.setter
	def runtest(self, new_state):
		self._setter_access_tracker["runtest"] = {}
		global default_state
		self._runtest = runtestClass(new_state, default_state["runtest"])
	...
	def TextBox113(self, new_state):
		...
		global default_state
		self._TextBox113 = TextBox113Class(new_state, default_state["TextBox113"])
	...
	def Image115(self, new_state):
		...
		global default_state
		self._Image115 = Image115Class(new_state, default_state["Image115"])

	@property
	def preview(self):
		self._getter_access_tracker["preview"] = {}
		return self._preview
	@preview.setter
	def preview(self, new_state):
		self._setter_access_tracker["preview"] = {}
		global default_state
		self._preview = previewClass(new_state, default_state["preview"])

	@property
	def preview_wrapper(self):
		self._getter_access_tracker["preview_wrapper"] = {}
		return self._preview_wrapper
	@preview_wrapper.setter
	def preview_wrapper(self, new_state):
		self._setter_access_tracker["preview_wrapper"] = {}
		global default_state
		self._preview_wrapper = preview_wrapperClass(new_state, default_state["preview_wrapper"])

	@property
	def filename(self):
		self._getter_access_tracker["filename"] = {}
		return self._filename
	@filename.setter
	def filename(self, new_state):
		self._setter_access_tracker["filename"] = {}
		global default_state
		self._filename = filenameClass(new_state, default_state["filename"])
	...
	def Flex370(self, new_state):
		...
		global default_state
		self._Flex370 = Flex370Class(new_state, default_state["Flex370"])
	...
	def Image152(self, new_state):
		...
		global default_state
		self._Image152 = Image152Class(new_state, default_state["Image152"])
	...
	def _to_json_fields(self):
		return {
			...
			"runtest": self._runtest,
			"TextBox113": self._TextBox113,
			"Image115": self._Image115,
			"preview": self._preview,
			"preview_wrapper": self._preview_wrapper,
...
class TextBox107ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox107ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox107Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox107ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox107ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox107ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox107ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox108ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox108ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox108Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox108ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox108ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox108ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox108ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Image112ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image112ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image112Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image112ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image112ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image112ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image112ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Image113ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image113ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image113Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image113ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image113ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image113ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image113ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox109ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox109ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox109Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox109ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox109ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox109ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox109ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Button18ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Button18ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Button18Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Button18ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Button18ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Button18ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Button18ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex231Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex231ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex231ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex235Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex235ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex235ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Flex236Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex236ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex236ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class TextBox111ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox111ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox111Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox111ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox111ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox111ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox111ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class TextBox112ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox112ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox112Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox112ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox112ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox112ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox112ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex237Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex237ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex237ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Image114ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image114ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image114Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image114ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image114ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image114ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image114ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class image_placeholderClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class image_placeholderClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: image_placeholderClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = image_placeholderClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class runtestClass:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: runtestClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = runtestClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class TextBox113ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox113ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class TextBox113Class:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: TextBox113ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TextBox113ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TextBox113ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TextBox113ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Image115ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image115ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image115Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image115ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image115ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image115ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image115ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class previewClass:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: previewClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: previewClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = previewClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = previewClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class preview_wrapperClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class preview_wrapperClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onClick = False
		self.styles: preview_wrapperClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = preview_wrapperClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class filenameClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class filenameClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class filenameClass:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: filenameClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: filenameClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = filenameClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = filenameClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
...
class Flex370Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Flex370ClassstylesClass = get_defined_value(state, def_state, "styles")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Flex370ClassstylesClass(state, self._def_state["styles"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			}
...
class Image152ClassstylesClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image152ClasscustomClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class Image152Class:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onClick = False
		self.styles: Image152ClassstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: Image152ClasscustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = Image152ClassstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = Image152ClasscustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
